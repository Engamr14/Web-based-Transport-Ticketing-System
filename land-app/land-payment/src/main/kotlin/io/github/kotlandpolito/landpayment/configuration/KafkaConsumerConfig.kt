...
import io.github.kotlandpolito.landpayment.serialization.PaymentRequestDeserializer
...
class KafkaConsumerConfig(
    ...
    @Bean
    fun consumerFactory(): ConsumerFactory<String?, PaymentRequest?> {
    ...
    @Bean
    fun kafkaListenerContainerFactory(): ConcurrentKafkaListenerContainerFactory<String, PaymentRequest>? {
